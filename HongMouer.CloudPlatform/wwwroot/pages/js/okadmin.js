...
layui.use(["element", "form", "layer", "okUtils", "okTab", "okLayer", "okContextMenu", "okHoliday", "laydate"], function () {
   ...
   $(".layui-footer button.donate").click(function () {
      layer.tab({
         ...
         tab: [{
            title: "支付宝",
             content: "<img src='~/pages/images/zfb.jpg' width='200' height='300' style='margin: 0 auto; display: block;'>"
         }, {
            title: "微信",
                 content: "<img src='~/pages/images/wx.jpg' width='200' height='300' style='margin: 0 auto; display: block;'>"
         }]
      });
   });
   ...
   $("body").on("click", ".layui-footer button.communication, #noticeQQ", function () {
      layer.tab({
         ...
         tab: [{
            title: "QQ群4",
             content: "<img src='~/pages/images/qq4.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
         }, {
            title: "QQ群3（已满）",
                 content: "<img src='~/pages/images/qq3.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
         }, {
            title: "QQ群2（已满）",
                 content: "<img src='~/pages/images/qq2.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
         }, {
            title: "QQ群1（已满）",
                 content: "<img src='~/pages/images/qq1.png' width='200' height='300' style='margin: 0 auto; display: block;'/>"
         }]
      });
   });
